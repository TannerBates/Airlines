...
st.markdown("This applications is a Streamlit dashboard to analyze the sentiment of Tweets 🐦")
st.sidebar.markdown(" This applications is a Streamlit dashboard to analyze the sentiment of Tweets 🐦")
